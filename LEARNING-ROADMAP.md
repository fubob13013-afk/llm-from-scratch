...
| Phase 2 · 代码实现 | 5 | 15 | 🔜 待开发 | 约 150 行 gpt2.py |
| Phase 3 · 训练实战 | 4 | 19 | 🔜 待开发 | 自己训练的微型 GPT |
| Phase 4 · 理解优化 | 3 | 22 | 🔜 待开发 | 能解释设计决策 |
| Phase 5 · 进阶方向 | 选修 | — | 🔜 待开发 | 按兴趣选 1-2 方向 |
